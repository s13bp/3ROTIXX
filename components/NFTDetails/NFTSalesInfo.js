...
const style = {
    ...
    button:'flex w-[14rem] itmes-center cursor-pointer justify-center space-x-4 rounded-lg py-2 text-white',
        ...
        <div className={style.header} >
            ...
            <div className={style.mainContainer} >
                ...
                <div className={style.buttonsContainer} >
                    ...
                    <span className='textx-lg font-semibold' > Buy Now </span>
                    </div>
                    <div className={`${style.button} ${style.offerButton}`}  >
                        <BsFillTagFill className={style.buttonIcon} />
                        <span className='textx-lg font-semibold' >
                            Make Offer
                        </span>
                    </div>
                </div>
